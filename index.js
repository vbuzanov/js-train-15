...
function generateRandomPassword(length) {
  ...
  for (let i = 0; i < characters.length; i++) {
    ...
    strPassword += characters[i];
    if (strPassword.length === length) {
      break;
    }
  }
  return strPassword;
...
function calculateCircleArea(radius) {
  ...
  if (typeof radius === "number") {
    ...
    console.log("Помилка. Вхідне значення повинне бути числом");
    return null;
  }
}
...
function findMinMax(numbers) {
  ...
  if (Array.isArray(numbers)) {
    ...
    console.log("Помилка. Вхідне значення повинне бути масивом");
    return null;
  }
}
...
function calculateHypotenuse(a, b) {
  ...
  if (typeof a === "number" && typeof b === "number") {
    ...
    console.log("Помилка. Вхідні значення повинні бути числами");
    return null;
  }
}
...
function roundObjectValues(obj) {
  ...
  if (typeof obj === "object" && obj !== null) {
    ...
    const arr = arrFromObj.map(([key, value]) =>
...
function compareAndRound(num1, num2) {
  ...
  if (typeof num1 === "number" && typeof num2 === "number") {
    let numBigger = Math.max(num1, num2);
    return Math.round(numBigger);
  } else {
...
function isTotalPriceExceedsMaxPrice(products, maxPrice) {
  ...
  if (Array.isArray(products) && typeof maxPrice === "number") {
    ...
    console.log(
      "Помилка: products має бути масивом, maxPrice повинен бути числом"
    );
    return null;
  }
}
